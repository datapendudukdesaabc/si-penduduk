        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Data Ktp </h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr bgcolor="cream">
                                    ...
                                    <td><?= $data['alamat'] ?></td>
                                    <td>
                                        <a href="report/ktp_satu.php?id=<?= $data['no_urut'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/ktp_semua.php" target="_blank" class="btn btn-info btn-sm">
...
<div id="cetak_perbulan" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/ktp_perbulan.php" method="post">
        <h4>Pilih Bulan </h4>
...
<div id="cetak_pertahun" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/ktp_pertahun.php" method="post">
        <h4>Pilih tahun</h4>
        <select name="tahun" class="form-control">
          <?php
            for ($i=substr(date("d-m-Y"),6,4); $i > substr(date("d-m-Y"),6,4)-5; $i--) { ?>
